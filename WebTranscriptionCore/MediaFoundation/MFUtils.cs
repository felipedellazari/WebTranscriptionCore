...
using Microsoft.MediaFoundation.Transform;
using System;
...
namespace Microsoft.MediaFoundation.Misc
{
	...
	public class ConstPropVariant : IDisposable
	{
		...
		public override bool Equals(object obj)
		{
			...
			if ((!(obj is PropVariant p)) || (p.type != type))
			{
				bRet = false;
			}
			else
	...
	public class FourCC
	{
		...
		public static readonly FourCC RGB = new FourCC(0);
		public static readonly FourCC RLE8 = new FourCC(1);
		public static readonly FourCC RLE4 = new FourCC(2);
		public static readonly FourCC BITFIELDS = new FourCC(3);
		public static readonly FourCC JPEG = new FourCC(4);
		public static readonly FourCC PNG = new FourCC(5);
		public static readonly FourCC YUY2 = new FourCC("YUY2");
		public static readonly FourCC UYVY = new FourCC("UYVY");
		public static readonly FourCC I420 = new FourCC("I420");
		public static readonly FourCC MP42 = new FourCC("MP42");
		public static readonly FourCC NV12 = new FourCC("NV12");
		public static readonly FourCC MJPG = new FourCC("MJPG");
		public static readonly FourCC CXF2 = new FourCC("CXF2");
	...
	internal class RTIMarshaler : ICustomMarshaler
	{
		...
		static readonly RTIMarshaler[] s_rti = new RTIMarshaler[2];
