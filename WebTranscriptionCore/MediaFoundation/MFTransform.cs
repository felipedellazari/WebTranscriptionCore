...
namespace Microsoft.MediaFoundation.Transform
{
	#region Declarations
	...
	public interface IMFLocalMFTRegistration
	{
		[PreserveSig]
		int RegisterMFTs(
			 [In, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStruct)] MFT_REGISTRATION_INFO[] pMFTs,
			 int cMFTs
		);
	}
	...
	[ComImport, System.Security.SuppressUnmanagedCodeSecurity, Guid("901db4c7-31ce-41a2-85dc-8fa0bf41b8da"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
...
#else
		int GetAllSettings([In] System.Runtime.InteropServices.ComTypes.IStream pStream);
#endif
...
#else
		int SetAllSettings([In] System.Runtime.InteropServices.ComTypes.IStream pStream);
#endif
...
#else
[In] System.Runtime.InteropServices.ComTypes.IStream pStream,
#endif
 [Out] out Guid[] ChangedParam,
 [Out] out int ChangedParamCount
 );
